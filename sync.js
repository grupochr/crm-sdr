/* === SYNC - Firebase RTDB (sincronizacao aberta entre dispositivos) ===
   Espelha o estado local do CRM (localStorage) num no compartilhado no
   Firebase, para que todos os aparelhos vejam a mesma versao.
   Projeto Firebase dedicado: crm-sdr-1d6f4  /  no: crm
*/
(function(){
  var URL  = "https://crm-sdr-1d6f4-default-rtdb.firebaseio.com/crm.json";
  var KEYS = ["chr_crm_db_v1"];
